...
- Name: error-scenarios.spec.ts >> Error Scenarios >> should show validation error with empty string
- Location: tests/e2e/error-scenarios.spec.ts:40:3
...
Locator: [role="alert"], text=/enter.*ticker/i >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "[role="alert"], text=/enter.*ticker/i". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [role="alert"], text=/enter.*ticker/i >> nth=0
