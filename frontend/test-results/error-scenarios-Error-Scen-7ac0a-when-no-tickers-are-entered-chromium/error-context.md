...
- Name: error-scenarios.spec.ts >> Error Scenarios >> should show validation error when no tickers are entered
- Location: tests/e2e/error-scenarios.spec.ts:4:3
...
Locator: [role="alert"], .awsui-alert-error, text=/enter.*ticker/i >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "[role="alert"], .awsui-alert-error, text=/enter.*ticker/i". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [role="alert"], .awsui-alert-error, text=/enter.*ticker/i >> nth=0
...
- main [ref=e4]:
  - generic [ref=e8]:
    ...
    - generic [ref=e17]:
      - generic [ref=e23]:
        - textbox "Enter ticker symbols (e.g., AAPL, MSFT, GOOGL)" [ref=e26]
        - button "Run Scan" [active] [ref=e28] [cursor=pointer]
      - generic [ref=e32]:
        - group [ref=e34]:
          - generic [ref=e36]:
            - img
          - generic [ref=e38]: Please enter at least one ticker symbol
