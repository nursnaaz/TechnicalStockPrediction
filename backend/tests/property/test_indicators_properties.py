...
def volume_array_strategy(min_size=50, max_size=250):
    ...
    return st.lists(
        st.integers(min_value=1000, max_value=1000000000), min_size=min_size, max_size=max_size
...
class TestSMAProperties:
    ...
    @settings(max_examples=20)
    @given(price_array_strategy(min_size=50, max_size=250), st.integers(min_value=1, max_value=50))
...
class TestEMAProperties:
    ...
    @settings(max_examples=20)
    @given(price_array_strategy(min_size=50, max_size=250), st.integers(min_value=5, max_value=50))
...
class TestAverageVolumeProperties:
    ...
    @settings(max_examples=20)
    @given(volume_array_strategy(min_size=50, max_size=250), st.integers(min_value=1, max_value=50))
...
class TestRelativeStrengthProperties:
    ...
    def test_property_rs_with_various_periods(
        ...
        **Validates: Requirements 4.5**
        ...
        # Calculate manually
        ticker_return = (
            (ticker_prices[-1] - ticker_prices[-(period + 1)]) / ticker_prices[-(period + 1)]
        ) * 100
        market_return = (
            (market_prices[-1] - market_prices[-(period + 1)]) / market_prices[-(period + 1)]
        ) * 100
        expected_rs = ticker_return - market_return
    ...
    @settings(max_examples=20)
    @given(price_array_strategy(min_size=21, max_size=250, min_price=10.0, max_price=500.0))
