...
class TestScanStoreGet:
    ...
    async def test_get_preserves_ticker_data(self, store, sample_scan_response):
        ...
        assert retrieved_ticker.signals.price_above_sma50 == original_ticker.signals.price_above_sma50
        assert retrieved_ticker.signals.macd_above_signal == original_ticker.signals.macd_above_signal
