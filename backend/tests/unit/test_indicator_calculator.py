...
class TestRelativeStrengthCalculation:
    ...
    def test_relative_strength_outperformance(self):
        ...
        result = IndicatorCalculator.calculate_relative_strength(ticker_prices, market_prices, 4)
    ...
    def test_relative_strength_equal_performance(self):
        ...
        result = IndicatorCalculator.calculate_relative_strength(ticker_prices, market_prices, 2)
...
class TestCalculateAll:
    ...
    def test_calculate_all_with_sufficient_data(self):
        ...
        stock_data = StockData(ticker="AAPL", prices=prices, volumes=volumes, timestamps=timestamps)

        market_prices = np.linspace(200.0, 220.0, 60)
        market_data = StockData(
            ticker="SPY", prices=market_prices, volumes=volumes, timestamps=timestamps
        )
    ...
    def test_calculate_all_with_insufficient_data(self):
        ...
        stock_data = StockData(ticker="TEST", prices=prices, volumes=volumes, timestamps=timestamps)

        market_data = StockData(ticker="SPY", prices=prices, volumes=volumes, timestamps=timestamps)
    ...
    def test_calculate_all_with_partial_data(self):
        ...
        stock_data = StockData(ticker="MSFT", prices=prices, volumes=volumes, timestamps=timestamps)
    ...
    def test_calculate_all_returns_technical_indicators_instance(self):
        ...
        stock_data = StockData(
            ticker="GOOGL", prices=prices, volumes=volumes, timestamps=timestamps
        )
...
class TestEdgeCases:
    ...
    def test_identical_values(self):
        ...
        stock_data = StockData(ticker="FLAT", prices=prices, volumes=volumes, timestamps=timestamps)
