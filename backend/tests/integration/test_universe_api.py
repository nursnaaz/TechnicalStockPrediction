...
class TestUniverseBuilderAndApiClientIntegration:
    ...
    @pytest.mark.asyncio
    async def test_build_universe_and_fetch_data_for_valid_tickers(
        self, universe_builder, api_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_when_api_fails_for_specific_tickers(
        self, universe_builder, api_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_empty_ticker_list_raises_error_before_api_calls(
        self, universe_builder, api_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_all_invalid_tickers_raises_error_before_api_calls(
        self, universe_builder, api_client
    ):
    ...
    async def test_concurrent_fetches_for_universe(self, universe_builder, api_client):
        ...
        fetch_tasks = [api_client.fetch_stock_data(ticker) for ticker in valid_tickers]
    ...
    @pytest.mark.asyncio
    async def test_mixed_success_and_failure_with_concurrent_fetches(
        self, universe_builder, api_client
    ):
