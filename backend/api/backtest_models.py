...
class TradeResult(BaseModel):
    ...
    predicted_bullish: Optional[bool] = Field(default=None, description="True if a BUY: regime tradeable (not bearish) AND score >= regime threshold (65/75)")
...
class BacktestMetricsResponse(BaseModel):
    ...
    confusion_matrix: Optional[Dict[str, int]] = Field(default=None, description="TP/FP/FN/TN counts (regime-aware BUY vs max_gain>=5%)")
